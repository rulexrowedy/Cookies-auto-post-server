...
# ── Session: original __slots__ + img_idx + session_type ─────────────────────
class Session:
...
# ══════════════════════════════════════════════════════════════════════════════
# ORIGINAL FUNCTIONS — EXACT COPY, ZERO CHANGES
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
# NEW: AUTO-POST FEATURE (added on top — original code above unchanged)
# ══════════════════════════════════════════════════════════════════════════════
        ...
        try:
            ...
            while session.running:
                try:
                    ...
                    if mention_list:      parts.append(' '.join(mention_list))
...
# ══════════════════════════════════════════════════════════════════════════════
# UI — two tabs (original comment UI preserved inside Tab 1)
# ══════════════════════════════════════════════════════════════════════════════
...
col1.metric("Total Actions", total_comments)
...
if st.session_state.view_session:
    ...
    stype   = getattr(session, 'session_type', 'comment') if session else 'comment'
    label   = 'posts' if stype == 'post' else 'comments'
    icon    = '📸' if stype == 'post' else '💬'

    st.markdown(f"### {icon} Viewing Session: `{sid}`")
    ...
    if session:
        if session.running:
            st.markdown(
                ...
                f'{" (ID: " + session.profile_id + ")" if session.profile_id else ""}'
    ...
    # ── Tab 1: Original comment UI (unchanged from original) ──────────────────
    with tab1:
